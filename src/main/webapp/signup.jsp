		...
		<form action="<%=request.getContextPath()%>/reg" method="post">
			<div class="successmsg">${successMsg}</div>
				<div class="input-container">
	                 <input type="email" name="signEmail" id="signemail" placeholder="Email" style="margin-top:20px;">
	            </div>
				<div class="input-container">
	    			<input  class ="uname" type="text" id="username" name="signName" required placeholder="Username">
	            </div>
	            <div class="input-container">
	                <input class="pass" type="password" id="password" name="signPass" required placeholder="Password">
	            </div>
	            <div class="input-container">
	                <input type="submit" value="Sign Up"><br>
	 				<a href="login.jsp" style="font-size: 15px; text-decoration:none;margin-left:60px;">Already have an account? Login</a>           
	 			</div>
	     </form>
     </div>
