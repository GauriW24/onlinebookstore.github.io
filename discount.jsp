...
<div class="container">
    <div class="shop-content" style="margin-top:100px;">
		<div class="food-box">
	        <div class="pic">
	          <img src="./images/discount/db1.jpg"style="height:200px; width:200px;" class="food-img">
		        </div>
		        <p class="food-title">How to Win Friends <br>and Influence People</p>
		        <p class="food-title">Author: Dale Carnegie</p>
		        <strike>Rs.200</strike><a href="#" class="badge" style="text-decoration:none; background-color:brown;border-radius:50%;">20%</a>
		        <span class="food-price"> Rs.400/-</span>
		        <ion-icon name="cart" class="add-cart"></ion-icon>
      		</div>
	      	
		<div class="food-box">
	        <div class="pic"><img src="./images/discount/db2.jpg" style="height:200px; width:200px;" class="food-img"></div>
		       <p class="food-title">Gitanjali</p>
			   <p class="food-title">Author: Rabindranath Tagore</p>
	        	<strike>Rs.130 </strike><a href="#" class="badge" style="text-decoration:none; background-color:brown;border-radius:50%;">20%</a>
		        <span class="food-price"> Rs.109/-</span>
	        <ion-icon name="cart" class="add-cart"></ion-icon>
	      </div>
  
	      <div class="food-box">
	        <div class="pic"><img src="./images/discount/db3.jpg" style="height:200px; width:200px;" class="food-img"></div>
	         <p class="food-title">Gita Rahasya</p>
			   <p class="food-title">Author: Lokmanya Balgangadhar<br> Tilak</p>
	        <strike> Rs.350 </strike><a href="#" class="badge" style="text-decoration:none; background-color:brown;border-radius:50%;">10%</a>
		        <span class="food-price"> Rs.313/-</span>
	        <ion-icon name="cart" class="add-cart"></ion-icon>
	      </div>
  
	      <div class="food-box">
	        <div class="pic"><img src="./images/discount/db4.jpg" style="height:200px; width:200px;" class="food-img"></div>
	        	<p class="food-title">Glimpses of World History</p>
			   <p class="food-title">Author:Jawaharlal Nehru</p>
	        	<strike>Rs.625</strike><a href="#" class="badge" style="text-decoration:none; background-color:brown;border-radius:50%;">10%</a>
		        <span class="food-price"> Rs.569/-</span>
	        	<ion-icon name="cart" class="add-cart"></ion-icon>
	      </div>
	  </div>
</div>
