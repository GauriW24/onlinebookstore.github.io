...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse " id="navbarNav" style="color: black;">
	           <ul class="navbar-nav">
	              ...
	              <li class="nav-item">
	              	<a class="nav-link" href="newArrivals.jsp">New Arrivels</a>
	              </li>
	              <li class="nav-item">
	              	<a class="nav-link" href="discount.jsp">Disconts</a>
	              </li>
	       		  <li class="nav-item">
  ...
  <h3 class="mb-5">Contact us</h3>
    ...
    <div class="col-md-4">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d242118.43101755416!2d73.55108704339901!3d18.524360738178824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf2e67461101%3A0x828d43bf9d9ee343!2sPune%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1697173204409!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
		...
		<form action="<%=request.getContextPath()%>/Log" method="post">
		    ...
		    <div class="input-container" style="margin-top:20px;">
		    	...
		    	<input type="submit" value="Submit"><br>
		 		<a href="#" style="font-size: 15px; text-decoration:none;margin-left:110px;">Forgot Password?</a>           
		</form>
	</div>
