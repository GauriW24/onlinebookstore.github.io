...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse " id="navbarNav" style="color: black;">
	           <ul class="navbar-nav">
	            ...
	            <form class="d-flex" style="margin-left: auto;">
					<input class="form-control mr-sm-2" type="search" disabled placeholder="Search" aria-label="Search" >
	    		</form>
          </div>
        </div>
      </nav>
  ...
  <div class="carousel-inner">
   <div class="carousel-item active">
      <img src="./images/img1.jpg" class="d-block w-100" style="height:500px;" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./images/img2.jpg" class="d-block w-100" style="height:500px;" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./images/img1.jpg" class="d-block w-100" style="height:500px;" alt="...">
    </div>
